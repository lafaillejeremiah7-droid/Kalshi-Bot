...
class HypothesisGenerator:
    ...
    def _session_effects_hypotheses(self) -> list[Hypothesis]:
        ...
        return [
            ...
            Hypothesis(id="SE_007", category=HypothesisCategory.SESSION_EFFECTS, name="Pre-Holiday Bullishness", description="Day before multi-day market closure tends to be positive.", economic_rationale="Short sellers cover before holidays; optimism bias and reduced selling pressure create positive drift.", data_requirements=["Close"], signal_function=signals.pre_holiday_bullishness, expected_direction=1, data_limitations="Calendar-based; requires detection of market holidays."),
